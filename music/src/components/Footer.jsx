      ...
      <div className="container mx-auto flex flex-wrap justify-between items-start">
        ...
        <div className="w-full sm:w-1/2 md:w-auto mb-8 sm:mb-0">
          ...
          <div className="flex space-x-4 mt-2">
            <a href="#" className="text-xl hover:text-blue-500 transition-colors duration-300">
              <FaFacebook />
            </a>
            <a href="#" className="text-xl hover:text-blue-400 transition-colors duration-300">
              <FaTwitter />
            </a>
            <a href="#" className="text-xl hover:text-pink-500 transition-colors duration-300">
              <FaInstagram />
            </a>
            <a href="#" className="text-xl hover:text-red-500 transition-colors duration-300">
              <FaYoutube />
            </a>
          </div>
        </div>
